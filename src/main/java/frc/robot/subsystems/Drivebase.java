...
public class Drivebase extends Subsystem {	
  ...
  public void DriveWithSpeed() {
			...
			if (OI.DriverLeftBumper()){
				...
				RobotMap._frontLeftMotor.set(ControlMode.PercentOutput,  getJoystickWithDeadBand(OI.DriverRightJoystick()));
				RobotMap._frontRightMotor.set(ControlMode.PercentOutput,  getJoystickWithDeadBand(OI.DriverLeftJoystick()));
			}
	}
